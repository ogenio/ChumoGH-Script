...
[[ ! -e /usr/bin/trans ]] && wget -O /usr/bin/trans https://raw.githubusercontent.com/ogenio/Generador_Gen_VPS-MX/master/Install/trans &> /dev/null
...
wget https://raw.githubusercontent.com/ogenio/ChumoGH-Script/master/BOT/gerador/gerar.sh &>/dev/null
